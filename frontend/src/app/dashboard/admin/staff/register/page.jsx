...
import { specializations } from '../_components/data'
  ...
  return (
    <div className='w-full h-full'>
      <div className='flex justify-start items-baseline'>
        <Link className='flex justify-center w-fit cursor-pointer rounded-full px-1.5 py-2  hover:bg-gray-100' href={"/dashboard/admin/staff"}>
      ...
      <div className="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-mainBlue hover:bg-blue-950 text-white py-2 rounded-full"
            disabled={loading}
          >
